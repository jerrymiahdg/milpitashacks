    ...
    <div className="flex flex-col items-center p-20">
      ...
      <div className="flex gap-10 justify-center flex-col 2xl:flex-row max-w-3xl w-full">
        <CardContainer className="inter-var">
          <CardBody className="bg-neutral-700 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-yellow-500/[0.1] shadow-lg dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border ">
            <CardItem
              translateZ="50"
